"""
Django settings for bot_admin_drf project.
...
SECRET_KEY = 'django-insecure-x0n$p2nr3!e*(vee785&yw87qd-ye%eh$wxena!#27*(9=wk&v'
...
ROOT_URLCONF = 'bot_admin_drf.urls'
...
WSGI_APPLICATION = 'bot_admin_drf.wsgi.application'
